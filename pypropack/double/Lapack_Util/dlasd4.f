      SUBROUTINE DLASD4_H( N, I, D, Z, DELTA, RHO, SIGMA, WORK, INFO )
*
...
*
      ...
      END IF
      IF( N.EQ.2 ) THEN
         CALL DLASD5_H( I, D, Z, DELTA, RHO, SIGMA, WORK )
         RETURN
      END IF
*
...
*
     ...
     $             ( D( IIP1 )-D( IIM1 ) )*( D( IIM1 )+D( IIP1 ) )*TEMP1
            ...
            DD( 3 ) = DTIIP
            CALL DLAED6_H( NITER, ORGATI, C, DD, ZZ, W, ETA, INFO )
            IF( INFO.NE.0 )
     $         GO TO 240
         END IF
*

      SUBROUTINE DLAED6_H( KNITER, ORGATI, RHO, D, Z, FINIT, TAU, INFO)
*
...
*  =======
*
*  DLAED6_H computes the positive or negative root (closest to the origin)
*  of
*                   z(1)        z(2)        z(3)
*  f(x) =   rho + --------- + ---------- + ---------
*                  d(1)-x      d(2)-x      d(3)-x
...
*
      IF( FIRST ) THEN
         ...
         BASE = DLAMCH_H( 'Base' )
         SMALL1 = BASE**( INT( LOG( DLAMCH_H('SafMin')) / LOG(BASE) /
     $            THREE ) )
         SMINV1 = ONE / SMALL1

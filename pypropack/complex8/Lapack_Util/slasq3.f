      SUBROUTINE SLASQ3_H( I0, N0, Z, PP, DMIN, SIGMA, DESIG, QMAX, NFAIL,
     $                   ITER, NDIV, IEEE )
*
...
*  =======
*
*  SLASQ3_H checks for deflation, computes a shift (TAU) and calls dqds.
...
*
*  IEEE   (input) LOGICAL
*         Flag for IEEE or non IEEE arithmetic (passed to SLASQ5_H).
*
*  =====================================================================
*
*     .. Parameters ..
...
*     .. External Subroutines ..
      EXTERNAL           SLASQ4_H, SLASQ5_H, SLASQ6_H
*     ..
*     .. External Function ..
      REAL               SLAMCH_H
      EXTERNAL           SLAMCH_H
...
*        Choose a shift.
*
         CALL SLASQ4_H( I0, N0, Z, PP, N0IN, DMIN, DMIN1, DMIN2, DN, DN1,
     $                DN2, TAU, TTYPE )
*
...
*
   80    CONTINUE
*
         CALL SLASQ5_H( I0, N0, Z, PP, TAU, DMIN, DMIN1, DMIN2, DN,
     $                DN1, DN2, IEEE )
*
         NDIV = NDIV + ( N0-I0+2 )
         ITER = ITER + 1
...
*
   90 CONTINUE
      CALL SLASQ6_H( I0, N0, Z, PP, DMIN, DMIN1, DMIN2, DN, DN1, DN2 )
      NDIV = NDIV + ( N0-I0+2 )
      ITER = ITER + 1
      TAU = ZERO
*

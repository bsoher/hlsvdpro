      SUBROUTINE CLARNV_H( IDIST, ISEED, N, X )
*
...
*  =======
*
*  CLARNV_H returns a vector of n random complex numbers from a uniform or
*  normal distribution.
*
*  Arguments
*  =========
...
*  ===============
*
*  This routine calls the auxiliary routine SLARUV_H to generate random
...
*
      DO 60 IV = 1, N, LV / 2
         IL = MIN( LV / 2, N-IV+1 )
*
*        Call SLARUV_H to generate 2*IL real numbers from a uniform (0,1)
*        distribution (2*IL <= LV)
*
         CALL SLARUV_H( ISEED, 2*IL, U )
*
         IF( IDIST.EQ.1 ) THEN
*

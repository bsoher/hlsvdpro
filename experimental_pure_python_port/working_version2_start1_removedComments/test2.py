...
Test2 was originally created to let me test a variety of ways of getting svd 
values apart from the original HLSVDPro lanczopw() call. They all seem to 
work OK for the test data, but ... not thoroughly tested.  And lanczopw()
still seems to give results most similar (singular_values results) as the
original fortran call. 
...
def test(filename):
    ...
    print 'hankel_size = ' + str(hankel_size)

...
#     for i in range(reps):
#         result1 = hlsvdpro_scipy.hlsvdpro_scipy(observed, nsv_sought, hankel_size)
...
#     result2 = convert_result(result2, dwell_time)
    ...
    if SHOW_PLOT:
        ...
        phase = np.exp(1j*DTOR*(-200))     # was -110
...
def convert_result(result, dwell_time):
    ...
    nsv_found, singular_values, frequencies, damping_factors, amplitudes, phases = result

...
# Vespa modules
import vespa.common.util.xml_ as util_xml       # THIS IS VERY OLD, DOES NOT KNOW ABOUT
import vespa.hlsvd.dist.hlsvd as hlsvd          # hlsvdpro PACKAGE ... FIX BEFORE RUNNING bjs 2020
...
def test(filename):
    ...
    # for i, signal in enumerate(observed):
    #     print "otest.py: signal[{}] = {}".format(i, signal)

    # Call hlsvd()
    libhlsvd = "./original/dist/bin/osx-32/libhlsvd-32.dylib"

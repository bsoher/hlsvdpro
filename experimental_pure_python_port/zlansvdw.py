...
# c     %-----------------------------------------%
    if neig >= nsv_sought:
        ...
        if (JOBU == 'y') or (JOBV == 'y'):
            ...
            # rbt = dbdsqr.dbdsqr('u', j, ncvt, 0, ncc, bbb1_a, bbb1_b, workq, lanmax, work1, 1, workp, lanmax+1)
            # info, bbb1_a, bbb1_b, _, work1, workp = rbt

            rbt = dbdsqr.dbdsqr_cython('u', j, ncvt, 0, ncc, bbb1_a, bbb1_b, workq, lanmax, work1, 1, workp, lanmax+1)
            info, bbb1_a, bbb1_b, _, work1, workp = rbt

            # BJS - repeat of PS comment, dbdsqr() returns bbb1_a, bbb1_b, and 
            # work1 as lists that are shorter than they were on the way in. 
            # Subsequent code may not deal well with this size change. However,
            # at this point in the program, only workp is being accessed, so I
            # will skip padding them out again.

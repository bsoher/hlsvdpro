...
#
# This python wrapper is BSD licensed, and is an extension of the
...
def svdp_aprod(A, k, which='L', irl_mode=False, kmax=None,
    ...
    function that the Fortran lansvd() or lansvd_irl() calls will access.
    Rather, a precompiled aprod() function using *gemv() from BLAS will 
    be used. Because of this, the A parameter *has* to be a full 2D ndarray.

...
C       print *, "inside zreorth"

      if (k.le.0 .or. n.le.0) return

C       print *, " zreorth progress"
...
C          print *, "zreorth2: k = ", k, " p = ", p, ", q = ", q
         ...
         do i=p,q
            ...
            do j=1,n
               s = s + conjg( V(j,i))*vnew(j)
C                print *, "zr2: V(", j, ", ", i, ") = ", V(j,i)
C                print *, "zr2: vnew(", j, ") = ", vnew(j)
C                print *, "zr2: product = ", conjg( V(j,i))*vnew(j)
C                print *, "zr2: s = ", s
            enddo
            h = s

C             print *, "zreorth2: i = ", i, ", h = ", h
         ...
         enddo
         iblck = iblck + 2
C          print *, "zreorth2: index(", iblck, ") = ", index(iblck)

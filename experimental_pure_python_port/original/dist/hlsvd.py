"""
This is a Python wrapper for the hlsvd function exposed by the hlsvd
library. 

Copyright & license info is in the Vespa LICENSE file.
"""
# Python modules
...
def hlsvd(signals, nsv_sought, dwell_time, libhlsvd=None):
    ...
    return (nsv_found, singular_values, frequencies, damping_factors, 
            amplitudes, phases)
